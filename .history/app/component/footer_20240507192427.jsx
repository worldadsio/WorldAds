    ...
    return (
        <div className="bg-[#181818] ] w-full mt-20 lg:py-12 pt-12 lg:p-4">
            <div className="lg:w-[80%] w-[90%] lg:flex items-center justify-between mx-auto py-12" >
                <div>
                    <h1 className="lg:text-5xl text-3xl  lg:w-[500px] w-[250px] font-medium lg:text-start text-center text-white">Innovating Digital Advertising</h1>
                </div>
            ...
            <div className="text-white relative mx-auto mt-5 lg:w-[80%]">
                <div className="flex items-center gap-1 w-40 w-[90%] lg:w-[80%] lg:mx-0 mx-auto">
                ...
                <Image src="/FooterImage.png" alt="vector" width={231.11} height={231.11} className="absolute lg:-top-16 lg:block hidden z-20 lg:-right-44 "/>
