                ...
                <div className="lg:w-[90%] w-[95%] mx-auto">
                    ...
                    <div className="lg:flex lg:items-center justify-between ">
                        ...
                        <div className='my-4'>
                            ...
                            <p className='text-white text-left font-light lg:text-sm text-xs lg:text-start text-center lg:w-[300px]'>At Worldads, weare revolutionizing location-based advertising by harnessing the power of smart rooftop digital screens. Our innovative platform delivers programmatic advertisements that are not only precise but also captivating, tailored to the vehicle's exact location and time.</p>
                        </div>
                    </div>
