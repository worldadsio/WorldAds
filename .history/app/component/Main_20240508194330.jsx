            ...
            <div className='gradient-color h-[700px] w-full rounded-b-[60px] lg:pt-40 pt-24 px-5  sm:px-16 pb-14 relative  '>
                <div className="lg:w-[90%] w-[95%] mx-auto">
                    ...
                    <div className="lg:flex lg:items-center justify-between ">
                        ...
                        <div className="my-4">
                            <h1 className="lg:text-5xl text-2xl  lg:w-[650px] lg:text-start text-center text-white font1 ">Eeeeempowering Connections Through Digital Out-of-Home Advertising</h1>
