    ...
    return (
        <div className={`fixed w-full lg:p-10 py-10 z-40 ${isHeaderFixed ? 'bg-red-600' : 'bg-transparent'}`}>
            <div className={`w-[85%] mx-auto flex justify-between items-center bg-transparent`}>
                ...
                >
                    <div className='border border-white rounded-xl p-3 w-96'>
                        <ul className='px-5 flex items-center justify-between'>
                    ...
                    <Image  src="./assets/images/bars.svg" alt="Menu" width={}height={} className='w-6' />
                </button>
            </div>
        </div>
    );
