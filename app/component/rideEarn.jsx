  ...
  return (
    <div>
      <div
        id="ride"
        className={`${
          section == "#ride" ? "pt-[24vh] lg:pt-[20vh]" : "pt-0"
        } flex lg:flex-row flex-col-reverse h-max w-[80%] mt-20 mx-auto items-end justify-between `}
      >
        <div className="xl:w-[410px] md:w-[400px] lg:mt-0 mt-10 lg:mx-0 mx-auto">
          ...
          <p className="xl:text-lg lg:w-auto md:w-80  lg:text-sm text-md font-light lg:w-auto  lg:mx-0 mx-auto text-[#030303] lg:text-start text-center mt-5">
        ...
        <div>
          <Image
            ...
            width={453}
            height={357}
            className="lg:w-[563.48px] lg:h-[450.27px] lg:mx-0 mx-auto "
          />
        </div>
      </div>
    </div>
