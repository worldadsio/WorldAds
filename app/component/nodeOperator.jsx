        ...
        <>
            <div id="nodeOperator" className={`${section =="#nodeOperator" ? "pt-24": "pt-0"}  lg:flex w-[80%]  h-max mx-auto items-end justify-between  bg-center bg-no-repeat  bg-cover bg-fixed bg-[url('https://i.imgur.com/8CV5WAB.png')]`}>
                ...
                <img src="./arrow3.png" className="  lg:hidden  m-auto  my-6  " />
                    ...
                    <p className="xl:text-xl lg:text-sm text-md font-light lg:w-auto md:w-80   md:text-md  lg:mx-0 mx-auto text-[#030303] lg:text-start text-center mt-5">Become a cornerstone of digital advertising. Own a smart digital screen and start earning as advertisers choose your prime ad slots.</p>
